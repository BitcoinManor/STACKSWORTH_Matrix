...
#define MAX_FRAMES      4   // number of animation frames (keep at 4!)
...
void loop(void)
{
  ...
  if (bInit)
  {
    ...
    {
      mx.setPoint(0, (i*COL_SIZE) + 4, true);
      mx.setPoint(0, (i*COL_SIZE) + 2, true);
      mx.setPoint(1, (i*COL_SIZE) + 5, true);
      mx.setPoint(1, (i*COL_SIZE) + 4, true);
      mx.setPoint(1, (i*COL_SIZE) + 3, true);
      mx.setPoint(1, (i*COL_SIZE) + 2, true);
      mx.setPoint(2, (i*COL_SIZE) + 5, true);
      mx.setPoint(2, (i*COL_SIZE) + 1, true);
      ...
      mx.setPoint(4, (i*COL_SIZE) + 1, true);
      mx.setPoint(5, (i*COL_SIZE) + 5, true);
      mx.setPoint(5, (i*COL_SIZE) + 4, true);
      mx.setPoint(5, (i*COL_SIZE) + 3, true);
      mx.setPoint(5, (i*COL_SIZE) + 2, true);
      mx.setPoint(6, (i*COL_SIZE) + 4, true);
      mx.setPoint(6, (i*COL_SIZE) + 2, true);
    }
  }
  ...
  {
    int16_t col = idx-DATA_WIDTH+i;
    if (col >= 0 && col < mx.getColumnCount())  // Add bounds checking
      mx.setColumn(col, 0);
  }
  ...
  for (uint8_t i=0; i<DATA_WIDTH; i++)
  {
    int16_t col = idx-DATA_WIDTH+i;
    if (col >= 0 && col < mx.getColumnCount())  // Add bounds checking
      mx.setColumn(col, pacman[frame][i]);
  }
